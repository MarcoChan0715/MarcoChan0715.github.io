...
function setupTouchReorder(container, selector, mode) {
    ...
    container.addEventListener('pointerdown', (e) => {
        ...
        // Move the live dragged element out of the grid flow so the device list
        // does not keep reflowing underneath it on iPad. This stabilises the
        // first-slot / top-left drop position and prevents flicker.
