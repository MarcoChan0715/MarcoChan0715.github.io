...
if(lampTimerBtn) {
    lampTimerBtn.addEventListener('click', () => {
        if (isLampTimerRunning) {
            ...
            lampTimerBtn.textContent = 'Initialize Timer';
            ...
            <div class="card-body-complex">
                <div class="complex-col-left">
                    <div class="form-group">
                        ...
                        <button class="pro-btn run-routine-btn" data-config='${actionJSON}' data-trigger="${triggerVal}">Run Routine Now</button>
                    </div>
                    <div class="form-group">
                        <label>TRIGGER MATRIX</label>
                        <div class="dense-readout"><p>${triggerText}</p></div>
                    </div>
                </div>
                <div class="complex-col-right">
                    <div class="form-group">
                        <label>ROUTINE PARAMETERS</label>
                    ...
                    <div class="form-group" style="margin-top: auto;">
                        <div class="admin-buttons">
                            ...
                            <button class="danger-btn delete-routine-opt">Delete Sequence</button>
                        </div>
                    </div>
                </div>
            </div>
