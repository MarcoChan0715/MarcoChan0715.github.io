...
editLayoutBtn.addEventListener('click', () => {
    ...
    if (isEditMode) {
        ...
        if (mainScrollContainer) {
            mainScrollContainer.style.overscrollBehavior = 'contain';
        }
        homeGrid.style.touchAction = 'none';
        filtersContainer.style.touchAction = 'none';
        macrosContainer.style.touchAction = 'none';
        ...
        if (mainScrollContainer) {
            mainScrollContainer.classList.remove('layout-drag-active');
            mainScrollContainer.style.overflowY = '';
            mainScrollContainer.style.touchAction = '';
            mainScrollContainer.style.overscrollBehavior = '';
            mainScrollContainer.style.webkitOverflowScrolling = '';
        }
        document.documentElement.style.touchAction = '';
        homeGrid.style.touchAction = '';
        filtersContainer.style.touchAction = '';
        macrosContainer.style.touchAction = '';
...
// --- 16. ADVANCED VOICE ASSISTANT LOGIC ---
